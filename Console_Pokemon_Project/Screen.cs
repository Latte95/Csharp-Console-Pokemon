...
namespace Console_Pokemon_Project
{
    ...
    class Screen
    {
        ...
        public static char[,] pixel = new char[WINDOW_WIDTH, WINDOW_HEIGHT];
        // 출력 위치 상수
        ...
        static char[,] titleDisplayInfo = new char[,]
        {
    { '　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　'},
    { '　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','■','■','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　'},
    { '　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','■','　','　','■','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　'},
    ...
    { '　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　','　'}
        ...
        public static void TitleGraphic() //타이틀를 그리는 메서드
        {
            char[,] titleInfo = new char[titleDisplayInfo.GetLength(1), titleDisplayInfo.GetLength(0)];

            for(int y = 0; y < titleInfo.GetLength(0); y++)
            {
                for(int x = 0; x < titleInfo.GetLength(1); x++)
                {
                    titleInfo[y, x] = titleDisplayInfo[x, y];
                }
            }

            Screen.Print(titleInfo);
        }
